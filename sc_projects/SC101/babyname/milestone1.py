...
def add_data_for_name(name_data, year, rank, name):
    """
    :param name_data: dict, key: name of newborns, value: dict with year-rank pairs of the key's name.
    :param year: str, the year that user wants to add in
    :param rank: str, the rank that user wants to add in
    :param name: str, the name that user wants to add in (with param year and rank)
    Add name: {year: rank} into name_data
    """
